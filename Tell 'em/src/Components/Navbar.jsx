...
const Navbar = () => {
    ...
    const closeCreateTold = () => {
        setAppendCreateTold(false);
    }
    ...
    <div className="navbar bg-gradient-to-r from-cyan-500 to-green-300">
        ...
        <div className="dropdown">
            ...
            <ul
                ...
                <li onClick={handleCreateTold}><span>Create Told</span></li>
        ...
        {appendCreateTold && (
        <CreateTold onClose={closeCreateTold} /> // Passage de la fonction onClose
        )}
    </div>
    )
}
