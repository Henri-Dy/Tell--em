...
const Inscription = () => {
  ...
  return (
    ...
    className='flex items-center justify-center min-h-[90vh]'>
      <form onSubmit={handleSubmit} className='px-4 py-4 rounded-lg flex flex-col gap-4 bg-base-200 border border-cyan-400'>
  ...
  <input type="text" className="grow" placeholder="Email" />
        ...
        <p className='text-xs text-center'>Have  an account yet? <span className='text-green-400'><Link to="/Connexion">Sign in</Link></span></p>
      </form>
    </motion.div>
  );
};
