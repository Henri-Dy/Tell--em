...
<form className="max-w-[54em] mx-auto mt-[4em]">
  ...
  <div className="grid md:grid-cols-2 md:gap-6">
    ...
    <textarea id="message" rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-base-200 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500   dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:text-white" placeholder="Leave a comment..."></textarea>
  </div>
